...
public class PhysicalNode {
    ...
    private List<PhysicalNode> neighbors;
    ...
    public List<PhysicalNode> getNeighbors() {
        return neighbors;
    }

    public void setNeighbors(List<PhysicalNode> neighbors) {
    ...
    // Add a physical node without specifying for what range of buckets it will serve as a replica
